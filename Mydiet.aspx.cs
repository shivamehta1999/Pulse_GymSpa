...
public partial class Mydiet : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        using (SqlCommand cmd = new SqlCommand("SELECT UserId, DietPlan FROM Users where (Username = '" + Page.User.Identity.Name + "' OR Email='" + Page.User.Identity.Name + "')"))
        {
