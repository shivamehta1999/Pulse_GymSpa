<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Dashmaster.master" CodeFile="Myschedule.aspx.cs" Inherits="Myschedule" %>
                        ...
                        <asp:TemplateField>  
                            ...
                            <ItemTemplate>  
                                <asp:Image ID="img1" runat="server" CssClass="imgg" ImageUrl='  
                                    <%# "~/Images/"+Eval("Schedule") %>' Height="500px" Width="500px"  />  
                                </ItemTemplate>  
                                <EditItemTemplate>  
