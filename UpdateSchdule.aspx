<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Dashmaster.master" CodeFile="UpdateSchdule.aspx.cs" Inherits="UpdateSchdule" %>
                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <!-- /.row -->
                                <div>  
                                    <br /><br />
                <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" OnRowEditing="gv1_RowEditing" OnRowUpdating="gv1_RowUpdating" OnRowCancelingEdit="gv1_RowCancelingEdit" CssClass="gridview" OnPageIndexChanging="gv1_PageIndexChanging" PageSize="3" AllowPaging="true">  
                    ...
                    <Columns>  
                        ...
                        <asp:TemplateField>  
                            <HeaderStyle CssClass="hdrow" />  
                            <HeaderTemplate>  
                                <asp:Label ID="hlblimg" runat="server" Text="Schedule"></asp:Label>  
                            </HeaderTemplate>  
                            <ItemTemplate>  
